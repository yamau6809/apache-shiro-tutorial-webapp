...
<html>
  ...
  <body>
	...
	<a href="<c:url value="/roles/captain"/>">Role Page</a>.
	<br/>
      </shiro:hasRole>
      <shiro:hasRole name="Officers">Bad Guys
	<a href="<c:url value="/roles/officers"/>">Role Page</a>.
	<br/>
      </shiro:hasRole>
      <shiro:hasRole name="Enlisted">Enlisted
	<a href="<c:url value="/roles/enlisted"/>">Role Page</a>.
	  <br/>
      </shiro:hasRole>
    </p>
